/*!
 * @nuxt/generator v2.14.11 (c) 2016-2020
...
class Generator {
  constructor (nuxt, builder) {
    ...
    if (this.isFullStatic) {
      ...
      const publicPath = utils.isUrl(_publicPath) ? _publicPath : base;
      ...
      this.staticAssetsBase = utils.urlJoin(publicPath, this.options.generate.staticAssets.versionBase);
      if (manifest) {
        this.manifest = defu_1(manifest, {
          routes: []
        });
      }
    }
